...
public class Servers {
    ...
    public static void distribute(String question, String opt_a, String opt_b,
        ...
        try{
            ...
            thread_distribute("d",9874,question, opt_a, opt_b, opt_c, opt_d, correct_opt, weight, access_code);
    ...
    public static void sync_me(){
        try{
            // sync paralllely
            thread_sync("a",9871,"b",9872);
            thread_sync("a",9871,"c",9873);
            thread_sync("a",9871,"d",9874);
    ...
    public static void tell_access_rules(String access_code, int n_easy, int n_medium, int n_hard){
        try {
            ...
            thread_tell_access_rules("d", 9874, access_code, n_easy, n_medium, n_hard);
        }catch (Exception e){
